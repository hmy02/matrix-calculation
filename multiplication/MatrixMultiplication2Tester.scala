...
class MatrixMultiplication2Tester(dut: MatrixMultiplication2)
...
object MatrixMultiplication2Tester extends App {
  chisel3.iotesters.Driver(() => new MatrixMultiplication2(8, 8, 8)) { dut =>
    new MatrixMultiplication2Tester(dut)
  }
}